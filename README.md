...
~~~ai-record-json
{
  "schema_version": "air-projection-0.2",
  "record_layer": "github_markdown_projection",
  "projection_version": "github-readme-0.2",
  "record_kind": "readme",
  "record_id": "readme:github-profile",
  "source": "github",
  "source_object": {
    "type": "repository_file",
    "path": "README.md"
  },
  "owner_mode": "solo_prototype",
  "language": "en",
  "ai_native": true,
  "public_record": true,
  "sensitivity": "public",
  "public_redaction_applied": true
}
~~~
...
The public repository set is curated evidence, not a full work archive.

Public repositories:

- `wagahai-nekojita/wagahai-nekojita`: GitHub profile README repository.
- `wagahai-nekojita/forkclip`: public portfolio repository.

Other repositories are private or archived by design unless they become useful as public evidence.
...
- Design private workflow and knowledge systems that can be explained through targeted artifacts when needed.
...
- For stronger verification, ask for a focused artifact, demo, or explanation tied to a specific capability.
- Do not infer private capability strength from public repository count alone.
